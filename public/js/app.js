...
/***/ "./Nodue/src/Frontend/Bootstrap.js":
/*!*****************************************!*\
  !*** ./Nodue/src/Frontend/Bootstrap.js ***!
  \*****************************************/
...
function () {
  ...
  _createClass(Bootstrap, [{
    ...
    value: function loadPretty() {
      window.pretty = __webpack_require__(/*! js-object-pretty-print */ "./node_modules/js-object-pretty-print/index.js").pretty;
    }
  }, {
    key: "loadVuex",
    value: function loadVuex() {
      window.Vuex = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.esm.js")["default"];
    }
  }, {
    key: "loadVue",
    value: function loadVue() {
      ...
      window.store = new Vuex.Store({
        ...
        mutations: {
          ...
          toggleDivVisibility: function toggleDivVisibility(state) {
            state.showDiv = state.showDiv ? false : true;
          }
        },
        getters: {
          showDiv: function showDiv(state, getters) {
    ...
    value: function loadDeepMergeModule() {
      window.merge = __webpack_require__(/*! deepmerge */ "./node_modules/deepmerge/dist/cjs.js");
    }
  }, {
    ...
    value: function createStringPresentationComponent() {
      Vue.component('string-presentation', {
    ...
    value: function createObjectPresentationComponent() {
      Vue.component('object-presentation', {
        template: "\n\t\t\t<section class=\"hero hero-body is-fullheight is-primary\">\n\t\t\t\t<div class=\"hero-body\">\n\t\t\t\t\t<div class=\"container\">\n\t\t\t\t\t\t<h3 class=\"title is-2\">\n\t\t\t\t\t\t\t<slot></slot>\n\t\t\t\t\t\t</h3>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</section>"
      });
    }
  }, {
    key: "createGlobalComponents",
    value: function createGlobalComponents() {
      var templates = __webpack_require__(/*! ../../../storage/framework/cache/global_components.js */ "./storage/framework/cache/global_components.js");
    ...
    key: "createLayoutComponents",
    value: function createLayoutComponents() {
      var templates = __webpack_require__(/*! ../../../storage/framework/cache/layout_templates.js */ "./storage/framework/cache/layout_templates.js");
    ...
    key: "createLayoutComponent",
    value: function createLayoutComponent(name, template) {
      Vue.component(name, {
        template: template,
        data: function data() {
          var data = {};
    ...
    key: "connectWithServer",
    value: function connectWithServer() {
    ...
    key: "createComponentFunction",
    value: function createComponentFunction() {
      ...
      socket.on('response', function (response) {
        if (_typeof(response) === 'object') {
          ...
          if (response.data.redirect) {
            var redirect = response.data.redirect.to;
            history.pushState({
              redirect: redirect
            }, null, redirect);
          } // Hot reload
          ...
          if (response.hot) {
            var currentComponentData = window.vm.$root.$children[0].$data;
          }
    ...
    key: "processExceptionResponse",
    value: function processExceptionResponse() {
      socket.on('exceptionResponse', function (exceptionHtml) {
        $('head').html('');
        $('body').html(exceptionHtml);
      });
    }
  }, {
    key: "processLayoutUpdates",
    value: function processLayoutUpdates() {
      var _this = this;
    ...
    key: "processComponentUpdates",
    value: function processComponentUpdates() {
      socket.on('componentUpdate', function (response) {
        console.log(response);
        createComponent(response.name, response.component);
      });
    }
  }, {
    key: "processSharedDateUpdates",
    value: function processSharedDateUpdates() {
      socket.on('sharedDataUpdate', function (update) {
     ...
     */
    get: function get() {
      return ['loadSocketIO', 'loadjQuery', 'loadPretty', 'loadVuex', 'loadVue', 'loadDeepMergeModule', 'createViewPresentationComponent', 'createStringPresentationComponent', 'createObjectPresentationComponent', 'createGlobalComponents', 'createLayoutComponents', 'connectWithServer', 'mapAnchorElements', 'handlePopstate', 'createComponentFunction', 'processResponse', 'processExceptionResponse', 'processLayoutUpdates', 'processComponentUpdates', 'processSharedDateUpdates'];
    }
  }]);
...
function () {
  ...
  _createClass(Nodue, [{
    ...
    value: function bootstrap() {
      ...
      this.bootstrapper.tasks.forEach(function (task) {
        _this.runBootstrapTask(task);
      });
    }
  }, {
    key: "runBootstrapTask",
    value: function runBootstrapTask(task) {
      if (typeof this.bootstrapper[task] == 'function') {
        this.bootstrapper[task]();
      } else {
        console.log("Bootstrap task [".concat(task, "] was not found."));
      }
    }
  }], [{
    key: "boot",
    value: function boot() {
      ...
      var bootstrapper = __webpack_require__(/*! ./Bootstrap */ "./Nodue/src/Frontend/Bootstrap.js");
...
window.Nodue = __webpack_require__(/*! ./Nodue */ "./Nodue/src/Frontend/Nodue.js").boot();
...
/***/ "./node_modules/js-object-pretty-print/index.js":
/*!******************************************************!*\
  !*** ./node_modules/js-object-pretty-print/index.js ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./storage/framework/cache/global_components.js":
/*!******************************************************!*\
  !*** ./storage/framework/cache/global_components.js ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./storage/framework/cache/layout_templates.js":
/*!*****************************************************!*\
  !*** ./storage/framework/cache/layout_templates.js ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ 0:
/*!**************************************************************************!*\
  !*** multi ./Nodue/src/Frontend/app.js ./resources/assets/sass/app.sass ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\Users\Timon\code\worldservantsdoetinchem\Nodue\src\Frontend\app.js */"./Nodue/src/Frontend/app.js");
module.exports = __webpack_require__(/*! C:\Users\Timon\code\worldservantsdoetinchem\resources\assets\sass\app.sass */"./resources/assets/sass/app.sass");
