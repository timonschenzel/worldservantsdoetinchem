module.exports = `<app-layout>
    ...
    <section>
        <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
            ...
            <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Sponsoring</h1>
            ...
            <div class="flex flex-wrap flex-col sm:flex-row pt-12 my-12 sm:my-4">
                ...
                <div v-for="sponsor in sponsors" class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-1">
                    <n-sponsor :sponsor="sponsor"></n-sponsor>
                </div>
